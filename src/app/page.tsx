...
export default function HomePage() {
  ...
  const projects = [
    ...
    {
      title: "Bruna Almeida – Psicologia / Psicanálise",
      desc_en: "Landing page built for a clinical psychologist, featuring a minimalist and welcoming design that highlights psychoanalytic approach, background, and scheduling. Developed using Next.js, React, and Tailwind CSS, focusing on UX, accessibility, and SEO.",
      desc_pt: "Landing page desenvolvida para psicóloga clínica, com design minimalista e acolhedor, destacando abordagem psicanalítica, formação e agendamento. Desenvolvida com Next.js, React e Tailwind CSS, focando em UX, acessibilidade e SEO.",
      site: "https://brunalmeidapsi.com",
      repo: "https://github.com/jheype/bruna-almeida",
      previewSrc: "/bruna.gif",
      previewType: "image" as const,
    },
    {
      title: "Instituto Zavarise – Website Institucional",
      desc_en: "Institutional website built for a multidisciplinary clinic, focused on credibility, clear information, and a welcoming experience. Built with Next.js, React, and Tailwind CSS, with emphasis on performance, SEO, and security.",
      desc_pt: "Website institucional desenvolvido para uma clínica multidisciplinar, com foco em credibilidade, clareza das informações e experiência acolhedora. Construído com Next.js, React e Tailwind CSS, priorizando performance, SEO e segurança.",
      site: "https://instituto-zavarise.vercel.app",
      repo: "https://github.com/jheype/instituto-zavarise",
      previewSrc: "/zavarise.gif",
      previewType: "image" as const,
    },
  ];
